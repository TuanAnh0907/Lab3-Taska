    ...
    <div class="font-roboto">
        ...
        <div class="lg:grid lg:grid-cols-4 lg:gap-3 lg:mx-10 lg:my-3 mx-3 my-10 ">
            ...
            <div class=" lg:my-5 col-span-2 bg-cover bg-no-repeat bg-center h-108 w-full relative" style="background-image: url(../image/hot.png)" >
                <div
                    class="text-black absolute bg-white font-serif w-5/6 lg:w-3/4 ml-4 pl-2 lg:pl-10 lg:pr-5 text-xl lg:text-4xl -bottom-5 lg:-bottom-10 ">
                    What One Photo Tells Us About North <br> Korea’s Nuclear Program
                </div>
            ...
            <div class="lg:px-3 lg:col-span-1 lg:py-2 py-10">
                ...
                <div class="px-3 py-3 hover:shadow-md lg:text-xl border-dashed border-b border-gray">
                ...
                <div class="px-3 py-3 hover:shadow-md lg:text-xl border-dashed border-b border-gray hidden lg:block">
                    <a href="#">Jayalalithaa’s niece Deepa floats political outfit</a>
                </div>
                <div class="px-3 py-3 hover:shadow-md lg:text-xl border-dashed border-b border-gray hidden lg:block">
                    <a href="#">‘China made mistake of ignoring India’s talent’</a>
                </div>
                <div class="px-3 py-3 hover:shadow-md lg:text-xl border-dashed hidden lg:block">
                    <a href="#">Jayalalithaa’s niece Deepa floats political outfit</a>
                </div>
        ...
        <div class="lg:grid lg:grid-cols-4 lg:gap-2 mx-2 lg:mx-10 lg:ml-10 mt-4 ">
            ...
            <div class="lg:col-span-4 2xl:col-span-3 lg:border-t lg:border-b border-gray-300 lg:my-6 lg:w-full">
                ...
                <div
                    class="overflow-auto text-center font-merriweather inline-flex justify-between lg:pt-4 h-76 lg:h-72 lg:w-full">

                    <div class="relative flex-shrink-0 mr-3">
                        <p class="bg-white text-lg lg:text-xl mt-48 mx-6 lg:pl-5 lg:w-80 absolute">Woman Do Like to
                            Compete Against
                            Themselves</p>
                        <img src="../image/pic1.png" alt="" class="h-52 lg:h-60 w-auto">
                    </div>
                    ...
                    <div class="relative flex-shrink-0 mr-3">
                        <p class="bg-white text-lg lg:text-xl mt-48 mx-6 lg:pl-5 lg:w-80 absolute">Woman Do Like to
                            Compete Against
                            Themselves</p>
                        <img src="../image/pic2.png" alt="" class="h-52 lg:h-60 w-auto">
                    </div>
                    ...
                    <div class="relative flex-shrink-0 ">
                        <p class="bg-white text-lg lg:text-xl mt-48 mx-6 lg:pl-5 lg:w-80 absolute">Woman Do Like to
                            Compete Against
                            Themselves</p>
                        <img src="../image/pic3.png" alt="" class="h-52 lg:h-60 w-auto">
                    </div>
                </div>
            </div>
            ...
            <div class="col-span-1 ml-5 mt-2 relative hidden 4xl:block">
                ...
                <div class="brightness-50 absolute mt-6">
                    <div
                        class="bg-cover bg-no-repeat rounded-lg bg-centerh-96 w-100 h-72" style="background-image: url(../image/video.png)">
                    </div>
                </div>
        ...
        <div class="lg:grid lg:grid-cols-5 lg:gap-2 lg:ml-10 ml-3 my-2 h-auto ">
            ...
            <div class="lg:col-span-1 mx-1 lg:mx-5 border-none lg:boder-b lg:border-none border-gray">
                ...
                <div class="lg:my-3 lg:text-2xl font-merriweather"><b>An Alarmed Base Prods Democrats Into an All-Out
                        War</b>
                </div>
                ...
                <h1 class=" text-xl lg:text-2xl my-6 py-3 font-merriweather"> <b>Transgender Student on the Front
                        Lines of the Rights Battle </b> </h1>
            ...
            <div class="lg:col-span-2 lg:border-l border-gray-300 py-2 my-4">
                ...
                <div class="px-2 my-4 lg:ml-3 mb-3 ">
                    ...
                    <div class="py-3 gap-3 border-b border-dashed border-gray-300 inline-flex">
                        ...
                        <img src="../image/avt.png" alt="" class="w-36 h-24 text-right">
                    </div>
                </div>
                ...
                <div class="px-3 lg:ml-3 lg:mb-5 ">
                    ...
                    <div class="py-3 gap-3 border-b border-dashed border-gray-300 inline-flex">
                        <p class="text-xl">India’s government expressed shock after one citizen was killed and another
                            wounded in a bar in
                            suburban Kansas. Another wounded in a bar in suburban Kansas.</p>
                        <img src="../image/avt2.png" alt="" class="w-36 h-24 text-right">
                    </div>
                </div>
            ...
            <div class="lg:col-span-1 mr-0 lg:mr-20 px-4">
                ...
                <div class="inline-flex lg:block py-2">
                    <img class="pt-2 w-36 gap-5 h-24 lg:w-full lg:h-48" src="../image/sport.png" alt="">
                    <div
                        class="py-2 px-6 font-merriweather w-1/2 lg:w-full lg:px-0 text-lg lg:text-2xl border-0 lg:border-b border-gray-300">
        ...
        <div class="lg:grid lg:grid-cols-5 lg:gap-2 lg:mx-10 lg:my-3 lg:h-full ">
            ...
            <div class="lg:col-span-4 ">
                ...
                <div
                    class="xl:grid xl:grid-cols-4 xl:gap-2 lg:mb-3 lg:h-168 lg:border-b lg:border-dashed lg:border-l lg:border-gray-300">
                        ...
                        <div class="tab-content mx-5">
                            ...
                            <div id="trending" data-tab-content class="active">
                                <div class="py-4 flex-shrink-0 relative">
                                    ...
                                    <p
                                        class="absolute pt-32 lg:pt-96 ml-20 lg:ml-36 lg:w-128 text-sm lg:text-4xl text-white font-merriweather">
                                        Isro launches 104 satellites in a
                                        single mission to create world record</p>
                                    <p
                                        class="absolute pt-44 lg:pt-128 ml-20 lg:ml-36 lg:w-108 lg:text-2xl text-sm text-white ">
                                        2:30 | By Telegraph</p>
                                    <img src="../image/tenlua.png" alt=""
                                        class="2xl:w-256 lg:h-144 lg:w-full">
                                </div>
                            </div>
                            ...
                            <div id="news" data-tab-content class="">
                                <div class="py-4 flex-shrink-0 relative">
                                    <div
                                        class="absolute left-2 lg:left-8 top-40 lg:top-112 lg:text-4xl text-white lg:px-6 lg:py-4 px-4 py-2 border-2 rounded-full border-white">
                                        <i class="fa-solid fa-play"></i>
                                    </div>
                                    <p
                                        class="absolute pt-32 lg:pt-96 ml-20 lg:ml-36 lg:w-128 text-sm lg:text-4xl text-white font-merriweather">
                    ...
                    <div class="lg:col-span-1 w-full overflow-auto my-2 mt-8 hidden 2xl:block">
                        ...
                        <div class="w-80 h-56 relative">
                            <p class="absolute text-white text-xl mt-20 w-72 mx-3 font-merriweather">Isro launches 104
                                ...
                                mission </p>
                            <img src="../image/menu-img1.png" alt="">
                        </div>
                        ...
                        <div class=" w-80 h-56 relative">
                            <p class="absolute text-white text-xl mt-20 w-72 mx-3 font-merriweather">Isro launches 104
                                satellites in a single
                                mission </p>
                            <img src="../image/menu-img2.png" alt="">
                        </div>
                        ...
                        <div class=" w-80 h-56 relative">
                            <p class="absolute text-white text-xl mt-20 w-72 mx-3 font-merriweather">Isro launches 104
                                satellites in a single
                                mission </p>
                            <img src="../image/menu-img3.png" alt="">
                        </div>
                ...
                <div class="lg:grid lg:grid-cols-5 lg:gap-2 my-6 lg:pt-10 ml-10 overflow-auto h-full 2xl:h-148">
                    ...
                    <div class="lg:w-full lg:h-48 relative">
                        <img src="../image/img-sub/img1.png" alt=""
                            class="absolute w-32 h-32 mt-16 lg:ml-0 md:ml-128 sm:ml-108 vs:ml-52 lg:static lg:w-full lg:h-full lg:mx-0 lg:my-0">
                    ...
                    <div class="lg:w-full lg:h-48 relative">
                        <img src="../image/img-sub/img2.png" alt=""
                            class="absolute w-32 h-32 mt-16 lg:ml-0 md:ml-128 sm:ml-108 vs:ml-52 lg:static lg:w-full lg:h-full lg:mx-0 lg:my-0">
                    ...
                    <div class="lg:w-full lg:h-48 relative">
                        <img src="../image/img-sub/img3.png" alt=""
                            class="absolute lg:static w-32 h-32 mt-16 lg:ml-0 md:ml-128 sm:ml-108 vs:ml-52 lg:w-full lg:h-full lg:mx-0 lg:my-0">
                    ...
                    <div class="lg:w-full lg:h-48 relative">
                        <img src="../image/img-sub/img4.png" alt=""
                            class="absolute lg:static w-32 h-32 mt-16 lg:ml-0 md:ml-128 sm:ml-108 vs:ml-52 lg:w-full lg:h-full lg:mx-0 lg:my-0">
                    ...
                    <div class="lg:w-full lg:h-48 relative">
                        <img src="../image/img-sub/img5.png" alt=""
                            class="absolute lg:static w-32 h-32 mt-16 lg:ml-0 md:ml-128 sm:ml-108 vs:ml-52 lg:w-full lg:h-full lg:mx-0 lg:my-0">
            ...
            <div class="col-span-1 mx-5 h-auto hidden lg:block">
                ...
                <div class="hover:shadow-md text-xl border-b border-dashed border-gray-300 ">
                    ...
                    <div class="pl-10 py-5 relative">
                        <a href="#">5 buyout candidates the Celtics could target after quiet trade deadline</a>
                    </div>
                </div>
                <div class="hover:shadow-md text-xl border-b border-dashed border-gray-300">
                    <div class="absolute text-8xl text-lammo ">2</div>
                    <div class="pl-10 py-5 relative">
                        <a href="#">White House bars major news outlets from media gaggle</a>
                    </div>
                </div>
                <div class="hover:shadow-md text-xl border-b border-dashed  border-gray-300">
                    <div class="absolute text-8xl text-lammo ">3</div>
                    <div class="pl-10 py-5 relative">
                        <a href="#">Watch the removal of a Jeep buried in a Cape Cod sand dune for 40 years</a>
                    </div>
                </div>
                <div class="hover:shadow-md text-xl border-b border-dashed border-gray-300">
                    <div class="absolute text-8xl text-lammo ">4</div>
                    <div class="pl-10 py-5 relative">
                        <a href="#">2nd suspect arrested in gruesome Peabody double killing</a>
                    </div>
                </div>
                <div class="hover:shadow-md text-xl border-b border-dashed border-gray-300">
                    <div class="absolute text-8xl text-lammo ">5</div>
                    <div class="pl-10 py-5 relative">
                        <a href="#">6 charged in death of UConn student run over after party</a>
                    </div>
                </div>
                <div class="hover:shadow-md text-xl border-b border-dashed border-gray-300">
                    <div class="absolute text-8xl text-lammo ">6</div>
                    <div class="pl-10 py-5 relative">
                        <a href="#">Derek Jeter loves watching this Red Sox player play</a>
                    </div>
                </div>
                <div class="hover:shadow-md text-xl border-b border-dashed border-gray-300">
