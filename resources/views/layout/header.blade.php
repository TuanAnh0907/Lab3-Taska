    ...
    <header class="lg:mx-10 lg:mb-4 font-roboto ">
        <div class="inline-flex justify-between w-full lg:border-b border-gray-300 border-dashed ">
            ...
            <div class="text-center text-gray-400 py-1 lg:text-xl lg:pt-5">
            ...
            <div class="lg:text-right py-1 px-3 lg:py-5 lg:inline-block">
                ...
                <input class="hidden placeholder-px-4 focus:outline border-none lg:w-36 lg:h-10 lg:inline-block"
                    type="search" size="20" placeholder="SEARCH">
                <button class="bg-sport hidden lg:inline-block lg:w-24 lg:h-10">Log in</button>
            </div>

        </div>

        <div class=" w-full h-auto text-center lg:text-8xl lg:pt-3 lg:inline-block">
            <p class=" mt-5 text-center tetx-bitter hidden lg:block"> <b>The News</b> </p>
        </div>

        <div class="menu text-center w-full border-t border-b border-gray-300 lg:my-3 lg:py-3 hidden lg:inline-block">
            ...
            <a class="px-5 text-xl hover:bg-slate-300 border-gray-200 float-right text-blue pr-10" href="#">
